...
PLUGIN(NAME("wdc", "Western Digital vendor specific extensions"),
	COMMAND_LIST(
		...
		ENTRY("vs-smart-add-log-c1", "WDC Additional Smart Log for C1 Log page", wdc_vs_smart_add_log_c1)
		ENTRY("vs-smart-add-log-d0", "WDC Additional Smart Log for D0 Log page", wdc_vs_smart_add_log_d0)
		ENTRY("clear-pcie-correctable-errors", "WDC Clear PCIe Correctable Error Count", 
